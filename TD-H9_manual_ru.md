...
Если радиостанция стационарная, можно отключить GPS и станция будет отправлять заданные настройками координаты (пункты меню 7.33.8 Fixed Latitude, 7.33.9 Fixed Longitude и 7.33.10 Fixed Altitude).
